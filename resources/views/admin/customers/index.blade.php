                        ...
                        <tr class="hover:bg-slate-50/50">
                            ...
                            <td class="px-4 py-3 text-right">
                                <div class="flex items-center justify-end gap-1">
                                    ...
                                    <a href="{{ route('admin.customers.edit', $customer->customer_phone_e164) }}" class="p-2 rounded-lg text-slate-500 hover:bg-slate-100 hover:text-slate-800 transition-colors" title="Edit">
